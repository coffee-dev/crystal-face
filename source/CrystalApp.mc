	...
	function updateThemeColours() {
		...
		switch (theme) {
			...
			case :THEME_MONO_DARK:
				...
				App.getApp().setProperty("IndicatorBackgroundColour", Graphics.COLOR_BLACK);
				App.getApp().setProperty("MoveBarBackgroundColour", Graphics.COLOR_DK_GRAY);
				break;
			...
			case :THEME_RED_LIGHT:
				...
				App.getApp().setProperty("IndicatorBackgroundColour", Graphics.COLOR_WHITE);
				App.getApp().setProperty("MoveBarBackgroundColour", Graphics.COLOR_LT_GRAY);
				break;
		}
	}
